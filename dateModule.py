...
x = datetime.datetime(2018, 6, 1, 12, 8, 50, 100)#year, month, day,hour, min, seconds,microseconds
print(x)
#date format codes
print(x.strftime("%B"))
"""
...
#supports days, seconds, milliseconds, microseconds, hours, minutes, weeks
print(hours_before)

#subtraction btn dates 
days_before = today + timedelta(weeks=6)
diff = today - days_before
print(diff.days)